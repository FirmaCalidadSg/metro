...
<body>
    <div class="registroConfig">
        <div class="info">
            <div class="frame">
                <div class="text">
                    <div class="text-wrapper">Actualizar Departamento</div>
                </div>
                <div class="div">
                    <div class="frame-2">
                    ...
                    <div class="element">
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" name="nombre" class="select-register" value="<?php echo $departamento->nombre ?? ''; ?>" required>
                                </div>
                        ...
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <select name="pais" class="select-register" required>
...
<script>
    ...
    function closeModal(isSuccess) {
        ...
        if (isSuccess) {
            window.location.href = "<?php echo BASE_PATH; ?>/departamento";
        }
    }
    ...
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        fetch('/metro/app/departamento/editar/<?php echo $departamento->id; ?>', {
            method: 'POST',
            body: formData
        }).then(response => {
            if (!response.ok) {
