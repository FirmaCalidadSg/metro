<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <button onclick="agregarUsuario()" data-bs-toggle="modal" data-bs-target="#modal-id" class="btn-primary pull-right">Nuevo Usuario</button>
                ...
                <tbody>
                    ...
                    foreach ($usuarios as $usuario): ?>
                        <tr>
                            ...
                            <td>
                                <a onclick="editarUsuario(<?php echo $usuario->usuario_id; ?>)" data-bs-toggle="modal" data-bs-target="#modal-id" class="">
                                    <img class="" src="/metro/app/Assets/css/images/edit.svg" title="Editar">
                                </a>
                                <a id="eliminarBtn" class="" onclick="confirmarEliminar(<?php echo $usuario->usuario_id; ?>)">
                                    <img class="" src="/metro/app/Assets/css/images/delete.svg" title="Eliminar">
                                </a>
                                <a onclick="cambiarCredenciales(<?php echo $usuario->usuario_id; ?>)" class="btn-adjust">
