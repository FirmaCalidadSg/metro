...
<body>
    <div class="registroConfig">
        <div class="info">
            <div class="frame">
                <div class="text">
                    <div class="text-wrapper">Actualizar Procesos</div>
                </div>
                <div class="div">
                    <div class="frame-2">
                    ...
                    <div class="element">
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" name="nombre" class="select-register" value="<?php echo $proceso->nombre ?? ''; ?>" required>
                                </div>
...
<script>
    ...
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        fetch('/metro/app/proceso/editar/<?php echo $proceso->id; ?>', {
            method: 'POST',
            body: formData
        }).then(response => {
            if (!response.ok) {
