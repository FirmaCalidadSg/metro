...
<body>
    <div class="registroConfig">
        <div class="info">
            <div class="frame">
                <div class="text">
                    <div class="text-wrapper">Nueva Linea</div>
                </div>
                <div class="div">
                    <div class="frame-2">
            ...
            <form method="POST" class="form-register" action="/metro/app/linea/<?php echo isset($linea->id) && $linea->id > 0 ? 'actualizar' : 'crear'; ?>">
                    ...
                    <div class="element">
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" name="nombre" class="select-register" value="<?php echo $linea->nombre ?? ''; ?>" placeholder="Nombre" required>
                                </div>
                        ...
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <select class="select-register" name="proceso">
                ...
                <button type="submit" class="btn btn-primary">
                    <?php echo isset($linea->id) && $linea->id > 0 ? 'Actualizar' : 'Registrar'; ?>
                </button>
            </form>
...
<script>
    ...
    function closeModal(isSuccess) {
        ...
        if (isSuccess) {
            window.location.href = "<?php echo BASE_PATH; ?>/linea";
        }
    }
