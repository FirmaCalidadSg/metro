<div class="container">
    <form id="registroForm">
        ...
        <?php if ( $usuario->id == 0): ?>
            ...
            <div class="mb-3" id="credencial-div">
                <label for="credencial" class="form-label">Credencial:</label>
                <input type="text" id="credencial" name="credencial" class="form-control" value="<?php echo isset($usuario->credencial) ? $usuario->credencial : ''; ?>" required>
            </div>
        <?php endif; ?>
        ...
        <div class="mb-3">
            ...
            <input type="hidden" id="id" name="id" value="<?php echo $usuario->usuario_id; ?>">
        </div>
