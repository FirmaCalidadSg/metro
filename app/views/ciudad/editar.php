...
<body>
    <div class="registroConfig">
        <div class="info">
            <div class="frame">
                <div class="text">
                    <div class="text-wrapper">Actualizar Ciudad</div>
                </div>
                <div class="div">
                    <div class="frame-2">
            ...
            <form method="POST" class="form-register" action="/metro/app/ciudad/editar/<?php echo $ciudad->id; ?>">
                    ...
                    <div class="element">
                        <div class="textfield">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <!-- <input type="text" name="planta" class="select-register" value="<?php echo $ciudad->planta ?? ''; ?>" required> -->
                                </div>
                        ...
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <!-- <input type="text" name="linea" class="select-register" value="<?php echo $ciudad->linea ?? ''; ?>" required> -->
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                            </div>
                        </div>
                    ...
                    <div class="element">
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" name="nombre" class="select-register" value="<?php echo $ciudad->nombre ?? ''; ?>" required>
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                            </div>
                        </div>
                        ...
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <select name="departamento" class="select-register" required>
                    ...
                    <div class="element">
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" name="codigo_postal" class="select-register" value="<?php echo $ciudad->codigo_postal ?? ''; ?>" required>
                                </div>
                            </div>
                            <img class="underline" src="../../Assets/css/images/underline.svg" />
                        </div>
...
<script>
    ...
    function closeModal(isSuccess) {
        ...
        if (isSuccess) {
            window.location.href = "<?php echo BASE_PATH; ?>/ciudad";
        }
    }
    ...
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        fetch('/metro/app/ciudad/editar/<?php echo $ciudad->id; ?>', {
            method: 'POST',
            body: formData
        }).then(response => {
            if (!response.ok) {
