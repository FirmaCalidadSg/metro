        ...
        <div class="info">
            ...
            <form method="POST" class="form-register">
                    ...
                    <div class="element">
                        <div class="textfield">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" class="select-register" value="<?php echo $equipo->planta ?? ''; ?>" readonly>
                                </div>
                        ...
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" class="select-register" value="<?php echo $equipo->linea ?? ''; ?>" readonly>
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                            </div>
                        </div>
                ...
                <div class="btn-container">
                    ...
                    <button type="button" class="btn-eliminar" onclick="eliminarEquipo()">Eliminar</button>
                </div>
            </form>
        </div>
    </div>
