...
<body>
    <div class="registroConfig">
        <div class="info">
            <div class="frame">
                <div class="text">
                    <div class="text-wrapper">Actualizar Equipo</div>
                </div>
                <div class="div">
                    <div class="frame-2">
            ...
            <form method="POST" class="form-register" action="/metro/app/equipo/editar/<?php echo $equipo->id; ?>">
                    ...
                    <div class="element">
                        <div class="textfield">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <!-- <input type="text" name="planta" class="select-register" value="<?php echo $equipo->planta ?? ''; ?>" required> -->
                                </div>
                        ...
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <!-- <input type="text" name="linea" class="select-register" value="<?php echo $equipo->linea ?? ''; ?>" required> -->
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                            </div>
                        </div>
                    ...
                    <div class="element">
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" name="modelo" class="select-register" value="<?php echo $equipo->modelo ?? ''; ?>" required>
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                            </div>
                        </div>
                        ...
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" name="estado" class="select-register" value="<?php echo $equipo->estado ?? ''; ?>" required>
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                            </div>
                        </div>
                    ...
                    <div class="element">
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" name="nombre" class="select-register" value="<?php echo $equipo->nombre ?? ''; ?>" required>
                                </div>
                            </div>
                            <img class="underline" src="../../Assets/css/images/underline.svg" />
                        </div>
