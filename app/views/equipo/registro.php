...
<!--                             <?php foreach ($definicion as $value): ?>
                                <option value="<?php echo $value->id; ?>" <?php echo isset($equipo->planta) && $equipo->planta == $value->id ? 'selected' : ''; ?>>
                ...
                <div class="input">
                    ...
                    <div class="div-2">
                        <select class="select-register" name="linea">
                            <option value="">Seleccionar</option>
<!--                             <?php foreach ($definicion as $value): ?>
                                <option value="<?php echo $value->id; ?>" <?php echo isset($equipo->linea) && $equipo->linea == $value->id ? 'selected' : ''; ?>>
                                    <?php echo $value->nombre; ?>
                                </option>
                            <?php endforeach; ?> -->
                        </select>
