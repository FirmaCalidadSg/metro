...
<div class="consultas-capacidad">
    ...
    <div class="tiempo-de-operacion">
        <div class="frame-5">
            <div class="text-wrapper-10">Tiempo de operación[TO]</div>
            <!-- <button class="btn btn-success" id="verParos" data-toggle="modal" href='#modal-id'>
                 <img class="img-paro" src="../app/Assets/css/images/eye.svg"/>
                Agregar Producto
            </button> -->
            <button onclick="agregarUsuario()" data-bs-toggle="modal" data-bs-target="#modal-id" class="btn-primary">Agregar Producto</button>
        </div>
        <div class="operacion">
            <div class="drops-downs">
                <div class="element">
