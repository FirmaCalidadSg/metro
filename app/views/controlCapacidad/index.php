    ...
    <div class="card-body">
        <form id="toForm">
            <div class="row">
                ...
                <div class="col">
                    <label for="horaInicioInput" class="form-label">Hora Inicial</label>
                    <input type="time" class="form-control" id="horaInicioInput">
                </div>
                <div class="col">
                    <label for="horaFinInput" class="form-label">Hora Final</label>
                    <input type="time" class="form-control" id="horaFinInput">
                </div>
                <div class="col-3">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col">
                        <button type="button" class="btn btn-danger" id="calcularTiempo">Calcular Tiempo</button>
                    </div>
                </div>
        </form>
