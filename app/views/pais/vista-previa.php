...
<body>
    <div class="registroConfig">
        ...
        <div class="info">
            <div class="frame">
                <div class="text">
                    <div class="text-wrapper">Vista Previa del Pais</div>
                </div>
                <div class="div">
                    <div class="frame-2">
            ...
            <form method="POST" class="form-register">
                    ...
                    <div class="element">
                        <div class="textfield">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" class="select-register" value="<?php echo $pais->Linea ?? ''; ?>" readonly>
                                </div>
                    ...
                    <div class="element">
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" class="select-register" value="<?php echo $pais->nombre ?? ''; ?>" readonly>
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                            </div>
                        </div>
                        ...
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" class="select-register" value="<?php echo $pais->codigo ?? ''; ?>" readonly>
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                            </div>
                        </div>
                ...
                <div class="btn-container">
                    <button type="button" class="btn-editar" onclick="editarPais()">Editar</button>
                    <button type="button" class="btn-eliminar" onclick="eliminarPais()">Eliminar</button>
                </div>
            </form>
        </div>
    </div>
