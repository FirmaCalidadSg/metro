...
<body>
    <div class="registroConfig">
        <div class="info">
            <div class="frame">
                <div class="text">
                    <div class="text-wrapper">Actualizar País</div>
                </div>
                <div class="div">
                    <div class="frame-2">
            ...
            <form method="POST" class="form-register" action="/metro/app/pais/editar/<?php echo $pais->id; ?>">
                    ...
                    <div class="element">
                        <div class="textfield">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <!-- <input type="text" name="planta" class="select-register" value="<?php echo $pais->planta ?? ''; ?>" required> -->
                                </div>
                        ...
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <!-- <input type="text" name="linea" class="select-register" value="<?php echo $pais->linea ?? ''; ?>" required> -->
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                            </div>
                        </div>
                    ...
                    <div class="element">
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" name="nombre" class="select-register" value="<?php echo $pais->nombre ?? ''; ?>" required>
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                            </div>
                        </div>
                        ...
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" name="codigo" class="select-register" value="<?php echo $pais->codigo ?? ''; ?>" required>
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                            </div>
                        </div>
...
<script>
    ...
    function closeModal(isSuccess) {
        ...
        if (isSuccess) {
            window.location.href = "<?php echo BASE_PATH; ?>/pais";
        }
    }
    ...
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        fetch('/metro/app/pais/editar/<?php echo $pais->id; ?>', {
            method: 'POST',
            body: formData
        }).then(response => {
            if (!response.ok) {
