        ...
        <div class="info">
            ...
            <form method="POST" class="form-register">
                    ...
                    <div class="element">
                        <div class="textfield">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" class="select-register" value="<?php echo $producto->planta ?? ''; ?>" readonly>
                                </div>
                        ...
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" class="select-register" value="<?php echo $producto->linea ?? ''; ?>" readonly>
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                            </div>
                        </div>
                ...
                <div class="btn-container">
                    ...
                    <button type="button" class="btn-eliminar" onclick="eliminarProducto()">Eliminar</button>
                </div>
            </form>
        </div>
    </div>
