...
<body>
    <div class="registroConfig">
        <div class="info">
            <div class="frame">
                <div class="text">
                    <div class="text-wrapper">Actualizar Daño</div>
                </div>
                <div class="div">
                    <div class="frame-2">
            ...
            <form method="POST" class="form-register" action="/metro/app/danoequipo/editar/<?php echo $dano->id; ?>">
                    ...
                    <div class="element">
                        <div class="textfield">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <!-- <input type="text" name="planta" class="select-register" value="<?php echo $dano->planta ?? ''; ?>" required> -->
                                </div>
                        ...
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <!-- <input type="text" name="linea" class="select-register" value="<?php echo $dano->linea ?? ''; ?>" required> -->
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                            </div>
                        </div>
                    ...
                    <div class="element">
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <select name="equipo" class="select-register" required>
                        ...
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="datetime-local" name="fecha" class="select-register" value="<?php echo $dano->fecha ?? ''; ?>" required>
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                            </div>
                        </div>
                    ...
                    <div class="element">
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" name="descripcion" class="select-register" value="<?php echo $dano->descripcion ?? ''; ?>" required>
                                </div>
                            </div>
                            <img class="underline" src="../../Assets/css/images/underline.svg" />
                        </div>
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" name="estado" class="select-register" value="<?php echo $dano->estado ?? ''; ?>" required>
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                            </div>
                        </div>
                ...
                <input type="hidden" name="id" value="<?php echo $dano->id ?? ''; ?>">
...
<script>
    ...
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        fetch('/metro/app/danoequipo/editar/<?php echo $dano->id; ?>', {
            method: 'POST',
            body: formData
        }).then(response => {
            if (!response.ok) {
