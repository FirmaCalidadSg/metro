    ...
    <table class="table table-bordered" id="table">
        <thead>
            <tr>
                ...
                <th>Produccion Ideal Teorica(U/H)</th>
                <th>Produccion Ideal Ajustada</th>
                <th>Acciones</th>
            </tr>
        </thead>
        <tbody>
            <?php foreach ($lineas_producto as $lineaproducto): ?>
                <tr>
                    ...
                    <td><?php echo $lineaproducto->nombre_planta; ?></td>
                    <td><?php echo $lineaproducto->nombre_proceso; ?></td>
                    <td><?php echo $lineaproducto->nombre_linea; ?></td>
                    <td><?php echo $lineaproducto->nombre_producto; ?></td>
                    <td><?php echo $lineaproducto->unidad; ?></td>
                    <td><?php echo $lineaproducto->peso; ?></td>
                    <td><?php echo $lineaproducto->rendimiento; ?></td>
                    <td><?php echo $lineaproducto->produccion_teorica; ?></td>
                    <td><?php echo $lineaproducto->produccion_ajustada; ?></td>
                    <td>
                        ...
                        <a href="../app/lineaproducto/editarFormulario/<?php echo $lineaproducto->id; ?>"
                            class="btn-warning">
