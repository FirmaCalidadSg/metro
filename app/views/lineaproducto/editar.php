...
<body>
    <div class="registroConfig">
        <div class="info">
            <div class="frame">
                <div class="text">
                    <div class="text-wrapper">Actualizar Linea y Producto</div>
                </div>
                <div class="div">
                    <div class="frame-2">
            ...
            <form method="POST" class="form-register" action="/metro/app/lineaproducto/editar/<?php echo $linea_producto->id; ?>">
                                ...
                                <div class="div-2">
                                    <select class="select-register" name="linea">
                                        ...
                                        <?php foreach ($lineas as $linea) { ?>
                                            <option value="<?php echo $linea->id; ?>" <?php echo $linea->id == $linea_producto->linea ? 'selected' : ''; ?>><?php echo $linea->nombre; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                                ...
                                <div class="div-2">
                                    <select class="select-register" name="producto">
                                        ...
                                        <?php foreach ($productos as $producto) { ?>
                                            <option value="<?php echo $producto->id; ?><?php echo $producto->nombre; ?>" <?php echo $producto->id == $linea_producto->producto ? 'selected' : ''; ?>><?php echo $producto->nombre; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                    ...
                    <div class="element">
                        <div class="textfield-2">
                            <div class="input">
                                ...
                                <div class="div-2">
                                    <input type="text" name="capacidad_produccion" class="select-register" value="<?php echo $linea_producto->capacidad_produccion ?? ''; ?>" required>
                                </div>
                                <img class="underline" src="../../Assets/css/images/underline.svg" />
                            </div>
                        </div>
                ...
                <input type="hidden" name="id" value="<?php echo $linea_producto->id ?? ''; ?>">
...
<script>
    ...
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        fetch('/metro/app/lineaproducto/editar/<?php echo $linea_producto->id; ?>', {
            method: 'POST',
            body: formData
        }).then(response => {
            if (!response.ok) {
